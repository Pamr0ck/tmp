...
int write_file(const char fileName[], int *buff);
...
int read_file(const char fileName[]){
    ...
    cout<<"mx = "<<fileInfoHeader.biHeight<< " my = "<<fileInfoHeader.biWidth<< " size "<<fileInfoHeader.biSize<<endl;
    ...
    */
    // WRITE
    ofstream fileOut;
    fileOut.open("/home/kot/etu_v2.0/cpp/test.bmp", ofstream::binary);
...
int write_file(const char fileName[]){
    ofstream fileStream;
    fileStream.open(fileName, ofstream::binary);
